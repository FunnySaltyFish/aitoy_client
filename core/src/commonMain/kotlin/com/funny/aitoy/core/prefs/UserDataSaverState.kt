...
fun currentUserDataOwnerId(): String {
    return if (AiToyPrefs.isLoggedIn) {
        "$UID_OWNER_PREFIX${AiToyPrefs.user.uid}"
    } else {
        "$DEVICE_OWNER_PREFIX${AiToyPrefs.deviceId}"
    }
}
...
fun <T> userDataSaverState(
    ...
    return object : MutableState<T> {
        ...
        private fun syncFromFallbackStore(ownerId: String, dataSaver: DataSaverInterface) {
            ...
            val fallbackOwnerId = "$DEVICE_OWNER_PREFIX${AiToyPrefs.deviceId}"
