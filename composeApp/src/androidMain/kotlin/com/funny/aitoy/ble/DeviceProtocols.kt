...
private object SvakomV2MultiFunctionProtocol : BleDeviceProtocol {
    private val serviceUuid = uuid("0000ffe0-0000-1000-8000-00805f9b34fb")
    private val writeUuid = uuid("0000ffe1-0000-1000-8000-00805f9b34fb")
...
private sealed class SvakomV2Profile(
    val status: BleProtocolStatus,
...
private data class SvakomV2Function(
    val code: Int,
    val type: String,
    val label: String,
    val command: Int,
...
private val SvakomV2Stretch = SvakomV2Function(1, "oscillate", "伸缩", 0x08, modeMax = 7, intensityMax = 1, strengthDriven = false)
private val SvakomV2Vibrate = SvakomV2Function(2, "vibrate", "震动", 0x03, modeMax = 10)
private val SvakomV2Suck = SvakomV2Function(3, "constrict", "吮吸", 0x09, modeMax = 5)
private val SvakomV2Flap = SvakomV2Function(4, "flap", "拍打", 0x07, modeMax = 7, intensityMax = 1, strengthDriven = false)
private val SvakomV2Heat = SvakomV2Function(5, "heat", "加热", 0x05, modeMax = 1, intensityMax = 1, strengthDriven = false)

/** 多功能协议里加热功能的固定功能码。 */
const val SvakomV2HeatFunctionCode: Int = 5

private val svakomV2FunctionsByType: Map<String, SvakomV2Function> =
...
private object SVAKOM_V2_STRETCH_VIBRATE : SvakomV2Profile(
...
private object SVAKOM_V2_SUCK : SvakomV2Profile(
    status = svakomV2Status(
...
private object SVAKOM_V2_FLAP : SvakomV2Profile(
    status = svakomV2Status(
...
private fun Int?.svakomV2Profile(): SvakomV2Profile =
    when (this) {
...
private fun kissToyTutuAuthResponse(challenge: ByteArray): ByteArray =
...
private fun kissToyTutuMotorPacket(motor1: Int, motor2: Int): ByteArray {
...
private fun KissToyOfficialV2Profile.kissToyOfficialV2BasicControlPacket(
    intensities: List<Int>,
    intensityMax: Int,
): ByteArray {
...
private fun Int.scaleKissToyOfficialV2BasicControlValue(intensityMax: Int, startUp: Double): Int {
...
private fun kissToyBleEncryptionSendBytes(data: List<Int>): ByteArray {
...
private fun kissToyBleEncryptionEncrypt(raw: IntArray): ByteArray {
...
private val KISS_TOY_BLE_ENCRYPTION_KEY_TAB = arrayOf(
...
private val KISS_TOY_OFFICIAL_V2_TYPE_1 = KissToyOfficialV2Motor(1, "震动")
private val KISS_TOY_OFFICIAL_V2_TYPE_2 = KissToyOfficialV2Motor(2, "第二震动")
private val KISS_TOY_OFFICIAL_V2_TYPE_3 = KissToyOfficialV2Motor(3, "吮吸")
private val KISS_TOY_OFFICIAL_V2_TYPE_4 = KissToyOfficialV2Motor(4, "伸缩")
private val KISS_TOY_OFFICIAL_V2_TYPE_6 = KissToyOfficialV2Motor(6, "拍打")
